/**
 * @file dial.c
 * @brief Module de création et gestion de la connexion UDP.
...
/**
 * @brief Initialise une socket UDP connectée à une machine et un port donnés.
 * 
 * Cette fonction utilise getaddrinfo() pour résoudre l'adresse, puis tente
 * de créer une socket IPv4/UDP. Elle renvoie un descritpeur de fichier
